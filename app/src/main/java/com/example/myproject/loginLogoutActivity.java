...
public class loginLogoutActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        try{
            ...
            ClickableSpan clickableSpan=new ClickableSpan() {
                ...
                public void onClick(View widget) {
                    ...
                    Intent intent=new Intent(loginLogoutActivity.this,loginActivity.class);//Must add the class to manifest
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.signup_button){
            ...
            if(inputId!=-1)
            {
                ...
                Toast.makeText(this,"You Can Now Login From Clicking Below: ",Toast.LENGTH_LONG).show();
